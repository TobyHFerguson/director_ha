...
export PATH=$PATH:/usr/sbin:/sbin; export PATH
...
sudo chmod a+r /opt/cloudera/parcel-repo/${PARCEL_NAME} /opt/cloudera/parcel-repo/$PARCEL_NAME.sha1 /opt/cloudera/parcel-repo/$PARCEL_NAME.sha
